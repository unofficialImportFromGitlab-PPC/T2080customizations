The dtb file, a flattened device-tree block with header in one binary blob, for the T2080rdb is compiled from a dts file, a text file containing a "source" for a device-tree.
